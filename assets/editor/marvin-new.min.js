!(function () {
    ...
    var a = (function () {
                ...
                i(t, null, [
                    {
                        key: "insert",
                        value: function (t) {
                            var n = t.getContainer().view;
                            "column" === n.getElementType() &&
                                n.addElement({
                                    elType: "section",
                                    isInner: !0,
                                    settings: {},
        ...
        l = (function () {
            function e(t) {
                n(this, e),
                    (this.widgetStorage = t),
                    (this.lastCopiedElement = ""),
                    (this.lastPastedElementModel = {});
            }
            return (
                i(e, [
                    {
                    ...
                    },
                    {
                        ...
                        value: function () {
                            var e = Object.values(
                                    elementor.getPreviewView().children._views
                                ).map(function (e) {
                        ...
                        value: function (e) {
                            ...
                            this.widgetStorage.fetch(function (n) {
                                if (
                                    "page" === n.widgetType &&
                                    n.widgetCode &&
                                    n.widgetCode.length > 0
                                ) {
                                    var o =
                                        elementor.$previewContents.find("html");
                                    return void jQuery
                                        .ajax({
                                            url: marvin.ajaxURL,
                                            method: "POST",
                                ...
                                if ("section" === l) {
                                    var p = null;
                                    "widget" === s
                                        ? (p = e.getContainer().parent.parent)
                                        : "column" === s
                                        ? (p = e.getContainer().parent)
                                        : "section" === s &&
                                          (p = e.getContainer()),
                                ...
                                if (
                                    r &&
                                    !_.isEmpty(t.lastPastedElementModel) &&
                                    ...
                                    return (
                                        ...
                                        void $e.run(
                                            "document/elements/create",
                                            {
                                                model: t.lastPastedElementModel,
                                                container: u,
                                                options: d,
                                            }
                                        )
                                        ...
                                        .done(function (e) {
                                            if (e.success) {
                                                ...
                                                var o = setTimeout(function () {
                                                    ...
                                                    (t.lastPastedElementModel =
                                                        elementorCommon.helpers.cloneObject(
                                                            e.model.toJSON()
                                                        )),
                                                        clearTimeout(o);
                                                }, 750);
            ...
            return (
                i(e, [
                    ...
                    },
                    {
                        key: "fetch",
                        value: function (e) {
                            return xdLocalStorage.getItem(
                                this.storageKey,
                                function (t) {
                                    var n = JSON.parse(t.value),
                                        o = new s(n.widgetType, n.widgetCode);
                                    e(o);
                                }
                            );
                        },
    ...
    (window.HWidgetStorage = c),
        (window.HSWidgetStorage = u),
        (window.HClipBoard = l),
        (window.HWidget = s);
    var d = /^((?!chrome|android).)*safari/i.test(navigator.userAgent),
        p = elementor.hooks.addFilter,
        m = d
            ? new u(
                  marvin.storageKey,
                  "https://happymonster.dev/storage/safari.php",
                  $
              )
            : new c(marvin.storageKey),
        g = new l(m);
    p("elements/widget/contextMenuGroups", function (e, t) {
        ...
        p("element/view", function (e, t) {
            var n;
            return "column" === t.get("elType")
                ? e.extend({
                      initialize: function () {
                          e.prototype.initialize.apply(this, arguments),
                              (n = this);
                      },
                      emptyView: e.prototype.emptyView.extend({
                          getContextMenuGroups: function () {
                              var t =
                                  e.prototype.emptyView.prototype.getContextMenuGroups.apply(
                                      this,
                                      arguments
                                  );
                              return a.prepareForBlankColumn(t, n, g);
                          },
                      }),
                  })
                : e;
